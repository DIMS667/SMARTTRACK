...
import { X, RotateCcw, Sun, Moon, Check } from 'lucide-react';
    ...
    <>
      ...
      <div className="fixed right-0 top-0 h-full w-80 bg-white dark:bg-gray-800 shadow-xl z-50 overflow-y-auto transform transition-transform duration-300 ease-out">
        <div className="p-6">
          ...
          {/* Sidebar Options - Seulement pour vertical et combo */}
          ...
          {/* Sidebar Colors - Nouvelle section */}
          <div className="mb-8">
            <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-3">
              Sidebar Colors
            </h4>
              ...
              {Object.entries(themes).map(([key, theme]) => (
                <div
                  ...
                  className={`relative p-3 border-2 rounded-lg cursor-pointer transition-all duration-200 hover:scale-105 ${
                    sidebarColor === key
                      ? 'border-purple-500 ring-2 ring-purple-500 ring-opacity-20 shadow-lg'
          ...
          {/* Navbar Colors - Nouvelle section */}
          <div className="mb-8">
            <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-3">
              Navbar Colors
            </h4>
          ...
          {/* Color Themes - Garde l'ancienne section pour la compatibilité */}
          <div className="mb-8">
            <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-3">
              Color Themes (Global)
            </h4>
