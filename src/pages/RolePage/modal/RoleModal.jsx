// src/pages/RolePage/modal/RoleModal.jsx
...
function RoleModal() {
  ...
  useEffect(() => {
    if (editingRole) {
      setFormData({
        ...
        color: editingRole.color || 'blue',
        members: editingRole.members || []
      });
    } else {
      setFormData({
        name: '',
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.name.trim()) {
      ...
      // Le modal se ferme automatiquement via le contexte
    }
  };
  ...
  const availableUsers = getAvailableUsers(editingRole?.id);
